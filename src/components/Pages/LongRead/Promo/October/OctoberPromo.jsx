...
const images = importAll(require.context('../../../../../assets/PROMO/October', false, /\.(jpg|jpeg|png)$/));

const links = {
  'Стать рекордсменом': 'https://cloud.akrussia.com/index.php/f/74704',
};
