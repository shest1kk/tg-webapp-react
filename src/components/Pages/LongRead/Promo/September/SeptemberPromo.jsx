...
const images = importAll(require.context('../../../../../assets/PROMO/September', false, /\.(jpg|jpeg|png)$/));

const links = {
  'Новый инструмент': 'https://cloud.akrussia.com/index.php/f/74704',
};
